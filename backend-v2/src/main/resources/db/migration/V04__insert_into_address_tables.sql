INSERT INTO common.province (id, "name") VALUES
(1, 'Thành phố Hà Nội'),
(2, 'Tỉnh Hà Giang'),
(4, 'Tỉnh Cao Bằng'),
(6, 'Tỉnh Bắc Kạn'),
...
INSERT INTO common.district (id, "name", province_id) VALUES
(1, 'Quận Ba Đình', 1),
(2, 'Quận Hoàn Kiếm', 1),
(3, 'Quận Tây Hồ', 1),
(4, 'Quận Long Biên', 1),
...
INSERT INTO common.ward (id, "name", district_id) VALUES
(1, 'Phường Phúc Xá', 1),
